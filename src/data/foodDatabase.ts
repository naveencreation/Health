...
const RAW_FOOD_DATABASE: FoodItem[] = [
  ...
  {
    id: 'sambar_rice',
    name: 'Sambar Rice (Sambar Sadham)',
    category: 'south_indian',
    categoryLabel: 'South Indian',
  ...
  {
    id: 'appam',
    name: 'Kerala Appam / Palappam (2 pcs)',
    category: 'south_indian',
    categoryLabel: 'South Indian',
    servingUnit: 'plate (2 pcs / 100g)',
    defaultServingSize: 1,
  ...
  {
    id: 'puttu',
    name: 'Steamed Kerala Puttu with Coconut',
    category: 'south_indian',
    categoryLabel: 'South Indian',
    servingUnit: 'cup (120g)',
    defaultServingSize: 1,
    calories: 215,
    carbs: 42,
    protein: 4.2,
  ...
  {
    id: 'idiyappam',
    name: 'Idiyappam / String Hoppers (3 pcs)',
    category: 'south_indian',
    categoryLabel: 'South Indian',
    servingUnit: 'plate (3 pcs / 120g)',
    defaultServingSize: 1,
    calories: 155,
    carbs: 34,
    protein: 2.8,
  ...
  {
    id: 'adai',
    name: 'Protein Multi-Lentil Adai',
    category: 'south_indian',
    categoryLabel: 'South Indian',
  ...
  {
    id: 'ragi_mudde',
    name: 'Karnataka Ragi Mudde (Ragi Ball)',
    category: 'south_indian',
    categoryLabel: 'South Indian',
    servingUnit: 'ball (150g)',
    defaultServingSize: 1,
    calories: 180,
    carbs: 38,
    protein: 3.8,
